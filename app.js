...
(function dartProgram() {
  ...
  F = {
    main: function() {
      ...
      vaihtoehdot.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Yes", "oikein", true], t1, t2));
      vaihtoehdot.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "No", "oikein", false], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Are these questions randomized?", "vaihtoehdot", vaihtoehdot], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Has Akseli studied Dart?", "vaihtoehdot", vaihtoehdot], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", 'Is "Yes" the correct answer to all of these??', "vaihtoehdot", vaihtoehdot], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Is this cool or what?", "vaihtoehdot", vaihtoehdot], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Is it possible to convert Dart-file to JS?", "vaihtoehdot", vaihtoehdot], t1, t2));
  ...
  F.lisaaVastausvaihtoehto_closure.prototype = {
    call$1: function(e) {
      ...
      if (H.boolConversionCheck(H._asBoolS(J.$index$asx(this.vaihtoehto, "oikein"))))
        ...
        C.DivElement_methods.set$text(t1, "Wrong!");
    },
    $signature: 4
  };
  (function aliases() {
